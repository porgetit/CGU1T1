...
PRUEBAS = {
    "1": ("Prueba de Caída Libre", "./caida_libre/pruebas.py"),
    "2": ("Prueba de Cálculo de Desplazamiento", "./calculo_desplazamiento/pruebas.py"),
    "3": ("Prueba de Conversor de Velocidad", "./conversor_velocidad/pruebas.py"),
    "4": ("Prueba de Lanzamiento de Proyectiles", "./lanzamiento_proyectiles/pruebas.py"),
    "5": ("Prueba de Producto Escalar", "./producto_escalar/pruebas.py"),
    "6": ("Prueba de Suma de Vectores", "./suma_vectores/pruebas.py"),
    "0": ("Salir", None),
}
